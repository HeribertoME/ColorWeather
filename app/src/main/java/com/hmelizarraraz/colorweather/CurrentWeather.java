...
/**
 * Created by heriberto on 21/01/17.
 */
...
public class CurrentWeather {
    ...
    public static final String PARTLY_CLOUDY_NIGHT  = "party-cloudy-night";
    public static final String FOG  = "fog";
    public static final String NA  = "na";
    public static final String PARTLY_CLOUDY_DAY  = "party-cloudy-day";
